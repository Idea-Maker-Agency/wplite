 ...
 * Add new field.
 */
function wplite_ajax_cf_repeater_add() {
...
add_action('wp_ajax_custom_fields__repeater_add', 'wplite_ajax_cf_repeater_add', 10);

/**
 * Remove field.
 */
function wplite_ajax_cf_repeater_remove() {
    global $wpdb;
...
add_action('wp_ajax_custom_fields__repeater_remove', 'wplite_ajax_cf_repeater_remove', 10);